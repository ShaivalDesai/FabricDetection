...
export default function Register() {
  ...
  const handleSubmit = async (event: any) => {
    ...
    // Create New FromData TO send Multiple Fields 
    ...
    if (selectedFile) {
        data.append('user_photo', selectedFile); // Append the selected file to the form data
    }
      try {
          const response = await axios.post(`${process.env.REACT_APP_Fast_API}/register`, data);
